    ...
    <div class="container py-5 mx-auto">
        <div class="lg:flex">
            <div class="w-full -mx-6 lg:w-2/5">
                <div class="px-6">
                    <a class="text-lg font-bold tracking-tighter text-blue-600 transition duration-500 ease-in-out transform tracking-relaxed lg:pr-8" href="{{route('home')}}"> <span class="text-green-400 font-bold">P2P</span> Crypto </a>
